...
EXP_NAME=qwen2_5_stage1_persona
DATA_PATH=/dfs/project/kgrlm/common/llm_twin/processed_data/reddit_processed_dataset_persona
...
#############################################
# Optional / Commented Config
#############################################
# Either set HUGGINGFACE_HUB_TOKEN in env or do trainer.hf_hub.token=
# +trainer.hf_hub.token="" 

# actor_rollout_ref.model.path="/dfs/project/kgrlm/common/llm_twin/models/Qwen2.5-7B-Instruct" \
