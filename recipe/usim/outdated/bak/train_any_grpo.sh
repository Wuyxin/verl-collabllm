...
EXP_NAME=qwen2_5_3b_bs64_n2_gptmini_bulletprompt_evalbyclaude_full
VERL_PATH="../verl"
DATASET=amazon  # reddit/amazon
DATA_PATH=$WORKING_DIR/data.new/${DATASET}/rl_real_${DATASET}_filtered
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name="verl_grpo_${DATASET}" \
