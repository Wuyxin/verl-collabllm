...
EXP_NAME=qwen2_5_TEST_1st_stage_tag_delete
VERL_PATH="./"
DATA_PATH="/dfs/project/kgrlm/common/llm_twin/data/reddit_debug_verl"
...
python3 -m verl.trainer.main_ppo \
    ...
    '+reward_model.reward_kwargs.metric_weights.response_tag_reward=1.0' \
    '+reward_model.reward_kwargs.response_metrics.tag_reward={}' \
    '+reward_model.reward_kwargs.val_response_metrics.tag_reward={}' \
